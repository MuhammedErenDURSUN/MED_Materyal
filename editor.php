            ...
            <div>
                ...
                <div style="background-color: white;padding: 16px;float: left;width: 100%;border-top: solid;border-width: 2px ">
                    ...
                    <div style="float: left;width: 100%;border-radius: 2px">
                        ...
                        <div class="row multi-columns-row col-lg-offset-3">
                            <ul class="works-grid works-grid-gut works-grid-3"   >
                                ...
                                <li class="work-item col-lg-4 col-md-4 col-sm-6 " ><a onclick="list_add('material_image')" >
                                        <div class="work-image" ><img id="material_image" src = "images/abstract-header.jpg" alt = "Portfolio Item" /></div >
                        ...
                        <h2  style="width: 100%;text-align: center">İçerik Galerisi</h2>
                            ...
                            <ul class="works-grid works-grid-gut works-grid-3 works-hover-w" >
                              ...
                              <li class="work-item col-lg-4 col-md-6 contents_card" style="margin-bottom: 16px" ><a onclick="list_add('video_list')" >
                                ...
                                <li class="work-item col-lg-4 col-md-6 contents_card" style="margin-bottom: 16px" ><a onclick="list_add('document_list')" >
                                        ...
                                        <div class="work-caption font-alt" >
                                            <h3 class="work-title" style="height: 136px"> </h3 >
                                            <h3 class="work-title" style="color: white"> Döküman İçerik Ekle</h3 >
                                        </div ></a >
                           ...
                           <a class="btn btn-border-d  btn-circle" style="margin: 4px" >İçerik Yön.</a>
   ...
   var contents_card=document.getElementById("contents_card");
    ...
    function yayinla() {
        ...
        for (var i=0; i<video_title.length; i++) {
            video_list+='{\"path\":\"'+video_title[i].innerText+'\"}';
        ...
        for (var i=0; i<image_title.length; i++) {
            image_list+='{\"path\":\"'+image_title[i].innerText+'\"}';
        ...
        for (var i=0; i<sound_title.length; i++) {
            sound_list+='{\"path\":\"'+sound_title[i].innerText+'\"}';
        ...
        for (var i=0; i<document_title.length; i++) {
            document_list+='{\"path\":\"'+document_title[i].innerText+'\"}';
        ...
        for (var i=0; i<link_title.length; i++) {
            link_list+='{\"path\":\"'+link_title[i].innerText+'\"}';
        ...
        for (var i=0; i<content_title.length; i++) {
            ...
            content_list+='{\"path\":\"'+content_title[i].innerText+'\"}';
        ...
        var material_image=material_selectedimg;//document.getElementById("material_image").src;
            ...
            material_list+='{\"image\":\"'+material_image+'\"}';



       var JSON='{"veri":[{"path":"'+document.getElementById("name0").innerHTML+'", "type":"'+document.getElementById("c_tur0").innerHTML+'"},' +
           '{"path":"'+document.getElementById("name1").innerHTML+'", "type":"'+document.getElementById("c_tur1").innerHTML+'"},' +
           '{"path":"'+document.getElementById("name2").innerHTML+'", "type":"'+document.getElementById("c_tur2").innerHTML+'"},' +
           '{"path":"'+document.getElementById("name3").innerHTML+'", "type":"'+document.getElementById("c_tur3").innerHTML+'"},' +
           '{"video":['+video_list+']},' +
           '{"sound":['+sound_list+']},' +
           '{"image":['+image_list+']},' +
   ...
   window.onresize = function(event) {
    ...
    card_size();
        if (first_content&&!add_content)
        {
            ...
            document.getElementById(view_type).src = "videos/loading.mp4";
            $.ajax({
                type: "POST",
                url: "tasks.php",
        ...
        $.ajax({
            ...
            success: function (data) {
             //   document.getElementById(view_type).src = "images/doc.png";
                document.getElementById("name"+view_type.slice(-1)).innerText = yol;
                document.getElementById("c_tur"+view_type.slice(-1)).innerText = "Döküman";
