...
$material_query = "Select * From materials where developer='".$name." ".$surname."'";
...
<main>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top navbar-transparent" role="navigation" style="background: linear-gradient(to bottom, #596164 0%, #596164 100%), radial-gradient(at top center, #596164 0%, #596164 120%) #989898;background-blend-mode: multiply,multiply;">
        ...
        if (strcmp($_GET['operation'], "publish") == 0)
        {
    ...
    <section class=" bg-dark-30" id="home" style="height: 520px;background: linear-gradient(to bottom, #596164 0%, #596164 100%), radial-gradient(at top center, #596164 0%, #596164 120%) #989898;
        ...
        <div class="titan-caption" style="margin-top: 88px" >
            <div class="caption-content">
                <div style="text-align: center" >
                    ...
                    <a class="btn  btn-link"  style="color:white;position: absolute;right: 16px;top: 0px; " onclick="session_destroy()"  >Oturum Kapat &nbsp; <i class="fa fa-sign-out"></i></a>


                    <img id="profile_img" src="images/user.png" style="height: 180px;width: 180px;border-radius:90px;left: 50%;margin-left: -90px;top: 32px;position: absolute">
                    <?php
                ...
                <div class="row multi-columns-row">
                    <ul class="works-grid works-grid-gut  works-hover-w outer" >
                        ...
                        foreach ($sql_materials as $row){
                            ...
                            if ($row['status'])
                            {
                                $yayin_img="publish_red.png";
                            }
                            else
                            {
                                $yayin_img="publish_black.png";
                            }

                            echo '<li class=" work-item2 works-grid works-hover-w  col-lg-2 col-md-3 col-sm-4 col-xs-6 " style="padding: 0" ><div style="margin: 0 4px;"><a href = "view.php?url_id='.$row['url_id'].'" >
                                   
                                    <div class="work-image" >
                                     <a style="position: absolute;left: 100%;margin-left: -36px;width:36px;height:36px;text-align:center;background-color:white;padding: 4px;border-bottom-left-radius: 4px" ><img title="Görüntüle"  src="images/'.$yayin_img.'"></a>
                                    <img class="image_view" src = "files/contents/'.$row['showcase'].'" alt = "Portfolio Item" /></div >
                                    <div class="work-caption font-alt" >
                                         <h3 class="work-title"  >'.$row['m_name'].' </h3 >
                                           <div class="work-descr" ><a href = "view.php?url_id='.$row['url_id'].'" > <img  style="height: 36px" title="Görüntüle"  src="images/eye.png"></a><img style="height: 36px;margin-left: 8px" title="Yayınla veya Yayından Kaldır" onclick="publish(\''.$row['url_id'].'\')" src="images/publish.png"></div>
...
<script type="text/javascript">
    ...
    function publish(id) {
        ...
        $.ajax({
            type: "POST",
            url: "tasks.php",
            data: {task: "publish_update",url_id: id},
            success: function (x) {
