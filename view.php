                            ...
                            for ($i=0;$i<4;$i++) {
                                ...
                                switch ($data->veri[$i]->type)
                                {
                                    ...
                                    case "Resim":{
                                        ...
                                        echo ' <div  class="work-image" style="background-color: black;border: 1px solid black" > <img class="image_view"  src="material_images/'.$data->veri[$i]->path .'"/>';
                                    ...
                                    case "Video":{
                                        ...
                                        echo '  <div  class="work_video"  style="background-color: black;border: 1px solid black" > <video  style="width: 100%;"  class="img-responsive" controls autoplay > <source src="videos/'.$data->veri[$i]->path .'" type="video/mp4"> </video>';
                                    ...
                                    case "Ses":{
                                     ...
                                     alt="Image" class="img-responsive">
                                              <audio  style="background-color: black;width: 100%;position: absolute;z-index: 99999"  class="img-responsive" controls controlsList="nodownload">  <h3 class="work-title" > Materyal </h3 > <source src="sound/'.$data->veri[$i]->path .'" type="audio/mpeg"> </audio>
                                </div>';
                        ...
                        <ul style="list-style-type: none;margin-top: 16px" >
                            ...
                            <li class=" col-lg-9 col-md-12 " id="video_card" style="padding: 0;padding-top: 8px" >
                                        ...
                                        <video id="video_view"
                                               ...
                                               class="img-responsive" controls>
                                            <source src="videos/<?php echo strtolower($data->veri[4]->video[0]->path) ?>" type="video/mp4">
                                        </video>
                                <div class="font-alt detail" >
                                    ...
                                    <img id="profile_img" src="material_images/<?php echo $sql_primary_material["showcase"] ?>" style="height: 64px;width: 64px;border-radius:32px;float: left;border:2px solid white;margin: 8px">
                                ...
                                <ul  style="list-style-type: none;max-height: 255px;overflow-x: scroll">
                                    ...
                                    <h4 > Açıklama  </h4 >
                                    <div class="font-alt detail" style="height: 320px">
                            ...
                            <li class=" col-lg-9 col-md-12 " id="image_card" style="padding: 0;padding-top: 8px;display: none" >
                                ...
                                <img id="image_view" src = "material_images/<?php echo $data->veri[6]->image[0]->path  ?>" alt = "Portfolio Item" />
                                </div>
                                <div class="font-alt detail" >
                                ...
                                <ul  style="list-style-type: none;max-height: 255px;overflow-x: scroll">
                                    ...
                                    foreach ($data->veri[6]->image as $image_row) {
                                        echo '<li onclick="img_display(\'image_view\',\'' . $image_row->path . '\')"  class="font-alt detail li_item" style="border-bottom: solid;border-bottom-color: #bdc3c7;border-width: 2px;padding: 12px;height: 51px"> <h3 class="work-title video_title" style="white-space: nowrap;width: 100%;overflow: hidden;text-overflow: ellipsis;float: left">' . $image_row->path . '</h3></li>';
                                    }
                                    ?>
                            ...
                            <li class=" col-lg-9 col-md-12 " id="sound_card" style="padding: 0;padding-top: 8px;display: none" >
                                <div  class="work-image" > <div style="">
                                        ...
                                        <img src="images/audio.png"
                                             style="position:absolute;width: 100px;height: 100px;left: 50%;margin-left: -50px;top: 50%;margin-top: -50px;"
                                             alt="Image" class="img-responsive">
                                        <audio id="sound_view" src="sound/<?php echo $data->veri[5]->sound[0]->path ?>"  style="background-color: black;width: 100%;position: absolute;z-index: 99999"  class="img-responsive" controls controlsList="nodownload">  <h3 class="work-title" > Materyal </h3 > <source  type="audio/mpeg"> </audio>
                                    </div></div>
                                <div class="font-alt detail" >
                                ...
                                <ul  style="list-style-type: none;max-height: 255px;overflow-x: scroll">
                                    ...
                                    foreach ($data->veri[5]->sound as $sound_row) {
                                        echo '<li onclick="sound_display(\'sound_view\',\'' . $sound_row->path . '\')"  class="font-alt detail li_item" style="border-bottom: solid;border-bottom-color: #bdc3c7;border-width: 2px;padding: 12px;height: 51px"> <h3 class="work-title video_title" style="white-space: nowrap;width: 100%;overflow: hidden;text-overflow: ellipsis;float: left">' . $sound_row->path . '</h3></li>';
                                    }
                                    ?>
                            ...
                            <li class=" col-lg-9 col-md-12 " id="link_card" style="padding: 0;padding-top: 8px;display: none" >
                                ...
                                <ul  style="list-style-type: none;max-height: 255px;overflow-x: scroll">
                                    ...
                                    foreach ($data->veri[8]->link as $link_row) {
                                        echo '<li onclick="link_display(\'link_view\',\'' . $link_row->path . '\')"  class="font-alt detail li_item" style="border-bottom: solid;border-bottom-color: #bdc3c7;border-width: 2px;padding: 12px;height: 51px"> <h3 class="work-title video_title" style="white-space: nowrap;width: 100%;overflow: hidden;text-overflow: ellipsis;float: left">' . $link_row->path . '</h3></li>';
                                    }
...
<script type="text/javascript">
    ...
    function video_display(view_type, yol) {
        ...
        document.getElementById(view_type).src = "videos/"+ yol;
        document.getElementById("video_title").innerText = yol;

    }
    function sound_display(view_type, yol) {

         document.getElementById(view_type).src =  'sound/' + yol;
    ...
    function img_display(view_type, yol) {
        ...
        document.getElementById(view_type).src = 'material_images/' + yol;
