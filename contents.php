...
<main>
 ...
 background-blend-mode: multiply,multiply;" class="navbar navbar-custom navbar-fixed-top navbar-transparent" role="navigation">
    ...
    <div class="modal fade" id="soundModal" tabindex="-1" style="z-index: 9999;" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document" style="width: 60%">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">İçerik Görüntüsü</h5>
                </div>
    ...
    <div class="modal fade" id="imageModal" tabindex="-1" style="z-index: 9999;" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document" style="width: 60%">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">İçerik Görüntüsü</h5>
                ...
                <div class="modal-body">
                    <div class="" style="margin-bottom: 16px" >
                        <div class="work-image" ><img id="image_view"  alt = "Portfolio Item" />
    ...
    <div class="modal fade" id="videoModal" tabindex="-1" style="z-index: 9999;" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document" style="width: 60%">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">İçerik Görüntüsü</h5>
                ...
                <div class="modal-body">
                    <div class="" style="margin-bottom: 16px" >
                        <div class="work-image" >
                            <video id="video_view"
                                   style="width: 100%;background-color: black;height: 100%"
                                   class="img-responsive" controls autoplay loop>
                                <source src="files/contents/world.mp4" type="video/mp4">
                            </video>
                        </div>
...
<script type="text/javascript">
    ...
    function open_content(id) {
        $.ajax({
            ...
            success:function (x) {
               document.getElementById('image_view').src=x+'/'+id;
               document.getElementById('sound_view').src=x+'/'+id;
               document.getElementById('video_view').src=x+'/'+id;
                document.getElementById('video_view').style.height= document.getElementById('video_view').offsetWidth*9/16+"px";
            }
        });
    }
